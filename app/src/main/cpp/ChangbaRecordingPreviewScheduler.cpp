...
JNIEXPORT void JNICALL Java_com_example_camerapreview_preview_ChangbaRecordingPreviewScheduler_switchCameraFacing
...
JNIEXPORT void JNICALL Java_com_example_camerapreview_preview_ChangbaRecordingPreviewScheduler_prepareEGLContext
...
JNIEXPORT void JNICALL Java_com_example_camerapreview_preview_ChangbaRecordingPreviewScheduler_createWindowSurface
...
JNIEXPORT void JNICALL Java_com_example_camerapreview_preview_ChangbaRecordingPreviewScheduler_resetRenderSize
...
JNIEXPORT void JNICALL Java_com_example_camerapreview_preview_ChangbaRecordingPreviewScheduler_destroyWindowSurface
(JNIEnv * env, jobject obj) {
	if(NULL != previewController) {
...
JNIEXPORT void JNICALL Java_com_example_camerapreview_preview_ChangbaRecordingPreviewScheduler_destroyEGLContext
(JNIEnv * env, jobject obj) {
	if(NULL != previewController) {
...
JNIEXPORT void JNICALL Java_com_example_camerapreview_preview_ChangbaRecordingPreviewScheduler_notifyFrameAvailable
(JNIEnv * env, jobject obj) {
	if(NULL != previewController) {
